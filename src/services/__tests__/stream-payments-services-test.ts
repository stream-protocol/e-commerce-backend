import { AbstractPaymentServiceTest, Cart, Data, Payment, PaymentSession, PaymentSessionStatus } from "@medusajs/medusa";
...
class streamPaymentsServiceTest extends AbstractPaymentServiceTest {
...
export default streamPaymentsServiceTest;
